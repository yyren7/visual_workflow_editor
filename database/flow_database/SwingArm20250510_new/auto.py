...
if __name__ == '__main__':
  while True:
    try:
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+6, message='moveP@15:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+6, message=f"moveP@15:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+6, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+6, message='moveP@15:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+6, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+6, message='moveP@15:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+6, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@15
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2007]']['name'], L.local_MR['seq_step[2007]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+8, message='moveP@16:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+8, message=f"moveP@16:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+8, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+8, message='moveP@16:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+8, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+8, message='moveP@16:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+8, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@16
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2009]']['name'], L.local_MR['seq_step[2009]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+10, message='moveP@56:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+10, message=f"moveP@56:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+10, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+10, message='moveP@56:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+10, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+10, message='moveP@56:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+10, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@56
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+11, message='moveP@57:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+11, message=f"moveP@57:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+11, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+11, message='moveP@57:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+11, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+11, message='moveP@57:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+11, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@57
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+12, message='moveP@21:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+12, message=f"moveP@21:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+12, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+12, message='moveP@21:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+12, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+12, message='moveP@21:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+12, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@21
      ...
      #;Post-Process:select_robot@2
      #;action:select_robot@2
      if(RAC.connected):
      ...
      L.TMS(L.local_T['block_timeout[14]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[14]']['name'], L.local_T['block_timeout[14]']['addr'])
      if (L.aax & L.iix):
        drive.register_error(no=801+14, message='set_motor@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.TMS(L.local_T['block_timeout[15]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[15]']['name'], L.local_T['block_timeout[15]']['addr'])
      if (L.aax & L.iix):
        drive.register_error(no=801+15, message='set_number@1:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+15, error_yaml=error_yaml)
      #;action:set_number@1
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+18, message='moveP@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+18, message=f"moveP@1:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+18, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+18, message='moveP@1:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+18, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+18, message='moveP@1:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+18, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@1
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2020]']['name'], L.local_MR['seq_step[2020]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+21, message='moveP@14:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+21, message=f"moveP@14:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+21, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+21, message='moveP@14:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+21, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+21, message='moveP@14:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+21, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@14
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2023]']['name'], L.local_MR['seq_step[2023]']['addr'])
      ...
      L.LDP(L.local_MR['seq_step[2025]']['name'], L.local_MR['seq_step[2025]']['addr'])
      if (L.aax & L.iix):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+28, message='moveP@28:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+28, message=f"moveP@28:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+28, message='moveP@28:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+28, message='moveP@28:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@28
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[30]']['name'], L.local_T['move_static_timer[30]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+30, message='moveP@59:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+30, message=f"moveP@59:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+30, message='moveP@59:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+30, message='moveP@59:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@59
      ...
      L.LD(L.local_MR['seq_step[30]']['name'], L.local_MR['seq_step[30]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[30]']['addr'], 0.0)
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2032]']['name'], L.local_MR['seq_step[2032]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+33, message='moveP@60:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+33, message=f"moveP@60:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+33, message='moveP@60:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+33, message='moveP@60:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@60
      ...
      L.TMS(L.local_T['block_timeout[35]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[35]']['name'], L.local_T['block_timeout[35]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+35, message='moveP@61:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+35, message=f"moveP@61:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+35, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+35, message='moveP@61:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+35, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+35, message='moveP@61:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+35, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@61
      ...
      L.MPP()
      L.LDPB(L.local_MR['seq_step[37]']['name'], L.local_MR['seq_step[37]']['addr'])
      ...
      L.OR(L.local_MR['seq_step[64]']['name'], L.local_MR['seq_step[64]']['addr'])
      L.OR(L.local_MR['seq_step[95]']['name'], L.local_MR['seq_step[95]']['addr'])
      L.OR(L.local_MR['seq_step[124]']['name'], L.local_MR['seq_step[124]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[39]']['name'], L.local_T['block_timer1[39]']['addr'])
      ...
      L.TMS(L.local_T['block_timeout[39]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[39]']['name'], L.local_T['block_timeout[39]']['addr'])
      if (L.aax & L.iix):
        drive.register_error(no=801+39, message='wait_timer@3:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+39, error_yaml=error_yaml)
      #;action:wait_timer@3
      L.LD(L.local_MR['seq_step[39]']['name'], L.local_MR['seq_step[39]']['addr'])
      L.TMS(L.local_T['block_timer1[39]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+40, message='set_output@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+41, message='wait_input@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+43, message='moveP@2:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+43, message=f"moveP@2:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+43, message='moveP@2:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+43, message='moveP@2:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@2
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(247.146, 10.0, 42.285, 0.0, 0.0, -32.643, 100.0, 100.0, 100.0, 0.1, 0, 0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, override)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[43]']['name'], L.local_MR['seq_step[43]']['addr'])
      L.ANB(L.local_MR['seq_step[2043]']['name'], L.local_MR['seq_step[2043]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.LD(L.local_MR['seq_step[43]']['name'], L.local_MR['seq_step[43]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[43]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+44, message='moveP@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+44, message=f"moveP@3:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+44, message='moveP@3:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+44, message='moveP@3:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@3
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2045]']['name'], L.local_MR['seq_step[2045]']['addr'])
      L.ANB(L.local_MR['seq_step[2041]']['name'], L.local_MR['seq_step[2041]']['addr'])
      L.ANL()
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[46]']['name'], L.local_T['move_static_timer[46]']['addr'])
      ...
      L.TMS(L.local_T['block_timeout[46]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[46]']['name'], L.local_T['block_timeout[46]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+46, message='moveP@4:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+46, error_yaml=error_yaml)
      #;error:moveP@4
      L.LD(L.local_MR['seq_step[46]']['name'], L.local_MR['seq_step[46]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+46, message=f"moveP@4:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+46, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+46, message='moveP@4:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+46, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+46, message='moveP@4:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+46, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@4
      L.LDP(L.local_MR['seq_step[46]']['name'], L.local_MR['seq_step[46]']['addr'])
      L.ANB(MR, 501)
      if ((L.aax & L.iix) and (RAC.connected)):
        offset_x = 0
        offset_y = 0
      ...
      L.LD(L.local_MR['seq_step[46]']['name'], L.local_MR['seq_step[46]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[46]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+48, message='moveP@5:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+48, message=f"moveP@5:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+48, message='moveP@5:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+48, message='moveP@5:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@5
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[49]']['name'], L.local_T['move_static_timer[49]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+49, message='moveP@18:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+49, message=f"moveP@18:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+49, message='moveP@18:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+49, message='moveP@18:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@18
      L.LDP(L.local_MR['seq_step[49]']['name'], L.local_MR['seq_step[49]']['addr'])
      L.ANB(MR, 501)
      if ((L.aax & L.iix) and (RAC.connected)):
        offset_x = 0
        offset_y = 0
      ...
      L.LD(L.local_MR['seq_step[49]']['name'], L.local_MR['seq_step[49]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[49]']['addr'], 0)


      #;Process:procedures_defnoreturn@2
      L.LD(L.local_MR['seq_step[47]']['name'], L.local_MR['seq_step[47]']['addr'])
      L.OR(L.local_MR['seq_step[86]']['name'], L.local_MR['seq_step[86]']['addr'])
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[51]']['name'], L.local_T['block_timer1[51]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+51, message='wait_timer@2:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+51, error_yaml=error_yaml)
      #;action:wait_timer@2
      L.LD(L.local_MR['seq_step[51]']['name'], L.local_MR['seq_step[51]']['addr'])
      L.TMS(L.local_T['block_timer1[51]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+52, message='set_output@2:A timeout occurred.', error_yaml=error_yaml)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+53, message='wait_input@2:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.OR(L.local_MR['seq_step[71]']['name'], L.local_MR['seq_step[71]']['addr'])
      L.OR(L.local_MR['seq_step[111]']['name'], L.local_MR['seq_step[111]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+55, message='wait_timer@12:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+55, error_yaml=error_yaml)
      #;action:wait_timer@12
      L.LD(L.local_MR['seq_step[55]']['name'], L.local_MR['seq_step[55]']['addr'])
      L.TMS(L.local_T['block_timer1[55]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+56, message='set_output@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+57, message='wait_input@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+59, message='moveP@17:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+59, message=f"moveP@17:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+59, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+59, message='moveP@17:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+59, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+59, message='moveP@17:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+59, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@17
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(247.146, 40.0, 12.0, 0.0, 0.0, -32.643, 100.0, 100.0, 100.0, 0.1, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, override)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[59]']['name'], L.local_MR['seq_step[59]']['addr'])
      L.ANB(L.local_MR['seq_step[2059]']['name'], L.local_MR['seq_step[2059]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+60, message='moveP@7:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+60, message=f"moveP@7:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+60, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+60, message='moveP@7:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+60, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+60, message='moveP@7:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+60, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@7
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[61]']['name'], L.local_T['move_static_timer[61]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+61, message='moveP@43:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+61, message=f"moveP@43:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+61, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+61, message='moveP@43:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+61, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+61, message='moveP@43:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+61, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@43
      ...
      L.LD(L.local_MR['seq_step[61]']['name'], L.local_MR['seq_step[61]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[61]']['addr'], 0.0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+62, message='moveP@8:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+62, message=f"moveP@8:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+62, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+62, message='moveP@8:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+62, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+62, message='moveP@8:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+62, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@8
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+63, message='moveP@9:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+63, message=f"moveP@9:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+63, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+63, message='moveP@9:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+63, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+63, message='moveP@9:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+63, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@9
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2064]']['name'], L.local_MR['seq_step[2064]']['addr'])
      L.ANB(L.local_MR['seq_step[2041]']['name'], L.local_MR['seq_step[2041]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+66, message='moveP@19:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+66, message=f"moveP@19:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+66, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+66, message='moveP@19:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+66, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+66, message='moveP@19:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+66, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@19
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[68]']['name'], L.local_T['move_static_timer[68]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+68, message='moveP@10:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+68, message=f"moveP@10:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+68, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+68, message='moveP@10:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+68, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+68, message='moveP@10:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+68, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@10
      L.LDP(L.local_MR['seq_step[68]']['name'], L.local_MR['seq_step[68]']['addr'])
      L.ANB(MR, 501)
      if ((L.aax & L.iix) and (RAC.connected)):
        offset_x = 0
        offset_y = 0
      ...
      L.LD(L.local_MR['seq_step[68]']['name'], L.local_MR['seq_step[68]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[68]']['addr'], 0.0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+69, message='moveP@11:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+69, message=f"moveP@11:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+69, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+69, message='moveP@11:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+69, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+69, message='moveP@11:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+69, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@11
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+70, message='moveP@12:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+70, message=f"moveP@12:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+70, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+70, message='moveP@12:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+70, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+70, message='moveP@12:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+70, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@12
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2071]']['name'], L.local_MR['seq_step[2071]']['addr'])
      L.ANB(L.local_MR['seq_step[2057]']['name'], L.local_MR['seq_step[2057]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+73, message='moveP@13:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+73, message=f"moveP@13:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+73, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+73, message='moveP@13:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+73, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+73, message='moveP@13:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+73, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@13
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+75, message='moveP@22:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+75, message=f"moveP@22:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+75, message='moveP@22:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+75, message='moveP@22:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@22
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+76, message='moveP@23:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+76, message=f"moveP@23:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+76, message='moveP@23:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+76, message='moveP@23:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@23
      ...
      L.OR(L.local_MR['seq_step[104]']['name'], L.local_MR['seq_step[104]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+78, message='wait_timer@13:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+78, error_yaml=error_yaml)
      #;action:wait_timer@13
      L.LD(L.local_MR['seq_step[78]']['name'], L.local_MR['seq_step[78]']['addr'])
      L.TMS(L.local_T['block_timer1[78]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+79, message='set_output@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.LDP(L.local_MR['seq_step[2079]']['name'], L.local_MR['seq_step[2079]']['addr'])
      if (L.aax & L.iix):
        L.resetRelay(L.local_MR['robot_io_success[0]']['name'], L.local_MR['robot_io_success[0]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+82, message='moveP@54:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+82, message=f"moveP@54:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+82, message='moveP@54:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+82, message='moveP@54:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@54
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+83, message='moveP@53:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+83, message=f"moveP@53:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+83, message='moveP@53:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+83, message='moveP@53:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@53
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+84, message='moveP@24:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+84, message=f"moveP@24:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+84, message='moveP@24:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+84, message='moveP@24:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@24
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+85, message='moveP@25:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+85, message=f"moveP@25:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+85, message='moveP@25:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+85, message='moveP@25:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@25
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2086]']['name'], L.local_MR['seq_step[2086]']['addr'])
      L.ANB(L.local_MR['seq_step[2053]']['name'], L.local_MR['seq_step[2053]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+87, message='moveP@26:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+87, message=f"moveP@26:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+87, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+87, message='moveP@26:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+87, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+87, message='moveP@26:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+87, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@26
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+88, message='moveP@58:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+88, message=f"moveP@58:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+88, message='moveP@58:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+88, message='moveP@58:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@58
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+89, message='moveP@27:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+89, message=f"moveP@27:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+89, message='moveP@27:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+89, message='moveP@27:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@27
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+90, message='moveP@20:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+90, message=f"moveP@20:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+90, message='moveP@20:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+90, message='moveP@20:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@20
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+96, message='moveP@32:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+96, message=f"moveP@32:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+96, message='moveP@32:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+96, message='moveP@32:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@32
      ...
      L.LD(L.local_MR['seq_step[96]']['name'], L.local_MR['seq_step[96]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[96]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+97, message='moveP@33:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+97, message=f"moveP@33:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+97, message='moveP@33:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+97, message='moveP@33:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@33
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+98, message='moveP@55:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+98, message=f"moveP@55:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+98, message='moveP@55:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+98, message='moveP@55:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@55
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+103, message='moveP@36:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+103, message=f"moveP@36:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+103, message='moveP@36:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+103, message='moveP@36:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@36
      ...
      L.LD(L.local_MR['seq_step[103]']['name'], L.local_MR['seq_step[103]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[103]']['addr'], 0)

      #;Process:procedures_callnoreturn@13
      L.LD(L.local_MR['seq_step[2103]']['name'], L.local_MR['seq_step[2103]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2104]']['name'], L.local_MR['seq_step[2104]']['addr'])
      L.ANB(L.local_MR['seq_step[2080]']['name'], L.local_MR['seq_step[2080]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+107, message='moveP@38:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+107, message=f"moveP@38:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+107, message='moveP@38:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+107, message='moveP@38:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@38
      ...
      L.LD(L.local_MR['seq_step[107]']['name'], L.local_MR['seq_step[107]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[107]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+109, message='moveP@39:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+109, message=f"moveP@39:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+109, message='moveP@39:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+109, message='moveP@39:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@39
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+110, message='moveP@40:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+110, message=f"moveP@40:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+110, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+110, message='moveP@40:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+110, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+110, message='moveP@40:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+110, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@40
      ...
      L.LD(L.local_MR['seq_step[110]']['name'], L.local_MR['seq_step[110]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[110]']['addr'], 0)

      #;Process:procedures_callnoreturn@14
      L.LD(L.local_MR['seq_step[2110]']['name'], L.local_MR['seq_step[2110]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2111]']['name'], L.local_MR['seq_step[2111]']['addr'])
      L.ANB(L.local_MR['seq_step[2057]']['name'], L.local_MR['seq_step[2057]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+119, message='moveP@47:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+119, message=f"moveP@47:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+119, message='moveP@47:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+119, message='moveP@47:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@47
      ...
      L.LD(L.local_MR['seq_step[119]']['name'], L.local_MR['seq_step[119]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[119]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+120, message='moveP@48:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+120, message=f"moveP@48:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+120, message='moveP@48:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+120, message='moveP@48:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@48
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+122, message='moveP@49:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+122, message=f"moveP@49:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+122, message='moveP@49:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+122, message='moveP@49:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@49
      ...
      L.LD(L.local_MR['seq_step[122]']['name'], L.local_MR['seq_step[122]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[122]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+123, message='moveP@50:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+123, message=f"moveP@50:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+123, message='moveP@50:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+123, message='moveP@50:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@50
      ...
      L.LD(L.local_MR['seq_step[123]']['name'], L.local_MR['seq_step[123]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[123]']['addr'], 0)

      #;Process:procedures_callnoreturn@7
      L.LD(L.local_MR['seq_step[2123]']['name'], L.local_MR['seq_step[2123]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2124]']['name'], L.local_MR['seq_step[2124]']['addr'])
      L.ANB(L.local_MR['seq_step[2041]']['name'], L.local_MR['seq_step[2041]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+125, message='moveP@51:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+125, message=f"moveP@51:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+125, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+125, message='moveP@51:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+125, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+125, message='moveP@51:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+125, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@51
      ...
      L.MPS()
      L.LDB(MR, 304)
      L.ANB(L.local_MR['seq_step[2126]']['name'], L.local_MR['seq_step[2126]']['addr'])
      L.ANL()
      L.OUT(L.local_MR['seq_step[126]']['name'], L.local_MR['seq_step[126]']['addr'])
      L.MPP()
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[126]']['name'], L.local_T['move_static_timer[126]']['addr'])
      ...
      #;timeout:moveP@52
      L.LD(L.local_MR['seq_step[126]']['name'], L.local_MR['seq_step[126]']['addr'])
      L.TMS(L.local_T['block_timeout[126]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[126]']['name'], L.local_T['block_timeout[126]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+126, message='moveP@52:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+126, error_yaml=error_yaml)
      #;error:moveP@52
      L.LD(L.local_MR['seq_step[126]']['name'], L.local_MR['seq_step[126]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+126, message=f"moveP@52:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+126, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+126, message='moveP@52:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+126, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+126, message='moveP@52:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+126, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@52
      L.LDP(L.local_MR['seq_step[126]']['name'], L.local_MR['seq_step[126]']['addr'])
      L.ANB(MR, 501)
      if ((L.aax & L.iix) and (RAC.connected)):
        offset_x = 0
        offset_y = 0
      ...
      L.LD(L.local_MR['seq_step[126]']['name'], L.local_MR['seq_step[126]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[126]']['addr'], 0.0)
      ...
      L.MPP()
      L.LDPB(L.local_MR['seq_step[127]']['name'], L.local_MR['seq_step[127]']['addr'])
