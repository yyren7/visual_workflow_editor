  ...
  while True:
    try:
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(524.873, -446.301, 146.043, 178.918, 0.521, -91.928, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(524.869, -446.293, 126.018, 178.916, 0.521, -91.929, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[2]']['name'], L.local_MR['seq_step[2]']['addr'])
      L.ANB(L.local_MR['seq_step[2002]']['name'], L.local_MR['seq_step[2002]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(524.88, -446.303, 95.996, 178.918, 0.519, -91.929, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[4]']['name'], L.local_MR['seq_step[4]']['addr'])
      L.ANB(L.local_MR['seq_step[2004]']['name'], L.local_MR['seq_step[2004]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[5]']['name'], L.local_T['block_timer1[5]']['addr'])
      ...
      L.TMS(L.local_T['block_timeout[5]']['addr'], 60000)
      L.LDP(L.local_T['block_timeout[5]']['name'], L.local_T['block_timeout[5]']['addr'])
      if (L.aax & L.iix):
        drive.register_error(no=801+5, message='wait_timer@5:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+5, error_yaml=error_yaml)
      #;action:wait_timer@5
      L.LD(L.local_MR['seq_step[5]']['name'], L.local_MR['seq_step[5]']['addr'])
      L.TMS(L.local_T['block_timer1[5]']['addr'], wait_msec=number_param_yaml['N483']['value'])

      #;Process:procedures_callnoreturn@9
      L.LD(L.local_MR['seq_step[2005]']['name'], L.local_MR['seq_step[2005]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2006]']['name'], L.local_MR['seq_step[2006]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+7, message='moveP@20:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+7, message=f"moveP@20:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+7, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+7, message='moveP@20:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+7, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+7, message='moveP@20:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+7, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@20
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(524.865, -446.294, 126.02, 178.915, 0.52, -91.929, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[7]']['name'], L.local_MR['seq_step[7]']['addr'])
      L.ANB(L.local_MR['seq_step[2007]']['name'], L.local_MR['seq_step[2007]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(98.003, -331.997, 348.002, 177.599, 2.269, -45.997, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[16]']['name'], L.local_MR['seq_step[16]']['addr'])
      L.ANB(L.local_MR['seq_step[2016]']['name'], L.local_MR['seq_step[2016]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-255.919, -163.018, 374.977, 177.37, -0.033, -134.997, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[21]']['name'], L.local_MR['seq_step[21]']['addr'])
      L.ANB(L.local_MR['seq_step[2021]']['name'], L.local_MR['seq_step[2021]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-5.633, -385.173, 293.248, -178.654, 0.128, 46.469, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[34]']['name'], L.local_MR['seq_step[34]']['addr'])
      L.ANB(L.local_MR['seq_step[2034]']['name'], L.local_MR['seq_step[2034]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(209.044, -467.708, 120.063, -179.393, 0.186, 47.739, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[35]']['name'], L.local_MR['seq_step[35]']['addr'])
      L.ANB(L.local_MR['seq_step[2035]']['name'], L.local_MR['seq_step[2035]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(209.058, -467.669, 59.974, -179.387, 0.18, 47.741, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[37]']['name'], L.local_MR['seq_step[37]']['addr'])
      L.ANB(L.local_MR['seq_step[2037]']['name'], L.local_MR['seq_step[2037]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.OR(L.local_MR['seq_step[117]']['name'], L.local_MR['seq_step[117]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.OR(L.local_MR['seq_step[78]']['name'], L.local_MR['seq_step[78]']['addr'])
      L.OR(L.local_MR['seq_step[109]']['name'], L.local_MR['seq_step[109]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-724.509, -161.986, 221.058, 178.474, -5.591, -130.967, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[52]']['name'], L.local_MR['seq_step[52]']['addr'])
      L.ANB(L.local_MR['seq_step[2052]']['name'], L.local_MR['seq_step[2052]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-724.477, -161.977, 170.709, 178.488, -5.576, -130.971, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[53]']['name'], L.local_MR['seq_step[53]']['addr'])
      L.ANB(L.local_MR['seq_step[2053]']['name'], L.local_MR['seq_step[2053]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-724.51, -161.985, 221.055, 178.474, -5.591, -130.967, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[56]']['name'], L.local_MR['seq_step[56]']['addr'])
      L.ANB(L.local_MR['seq_step[2056]']['name'], L.local_MR['seq_step[2056]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-511.237, -163.018, 337.45, 177.369, -0.033, 49.955, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[57]']['name'], L.local_MR['seq_step[57]']['addr'])
      L.ANB(L.local_MR['seq_step[2057]']['name'], L.local_MR['seq_step[2057]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-764.93, -171.664, 233.252, 179.563, -0.711, 46.618, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[58]']['name'], L.local_MR['seq_step[58]']['addr'])
      L.ANB(L.local_MR['seq_step[2058]']['name'], L.local_MR['seq_step[2058]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-768.807, -168.165, 214.958, -178.828, -1.055, 47.06, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[59]']['name'], L.local_MR['seq_step[59]']['addr'])
      L.ANB(L.local_MR['seq_step[2059]']['name'], L.local_MR['seq_step[2059]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-764.93, -171.656, 233.255, 179.565, -0.713, 46.618, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[62]']['name'], L.local_MR['seq_step[62]']['addr'])
      L.ANB(L.local_MR['seq_step[2062]']['name'], L.local_MR['seq_step[2062]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-511.236, -163.017, 337.492, 177.37, -0.032, -134.999, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[63]']['name'], L.local_MR['seq_step[63]']['addr'])
      L.ANB(L.local_MR['seq_step[2063]']['name'], L.local_MR['seq_step[2063]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.OR(L.local_MR['seq_step[101]']['name'], L.local_MR['seq_step[101]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[71]']['name'], L.local_T['block_timer1[71]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+71, message='wait_timer@13:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+71, error_yaml=error_yaml)
      #;action:wait_timer@13
      L.LD(L.local_MR['seq_step[71]']['name'], L.local_MR['seq_step[71]']['addr'])
      L.TMS(L.local_T['block_timer1[71]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+72, message='set_output@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.LDP(L.local_MR['seq_step[2072]']['name'], L.local_MR['seq_step[2072]']['addr'])
      if (L.aax & L.iix):
        L.resetRelay(L.local_MR['robot_io_success[0]']['name'], L.local_MR['robot_io_success[0]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+73, message='wait_input@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+75, message='moveP@54:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+75, message=f"moveP@54:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+75, message='moveP@54:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+75, message='moveP@54:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+75, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@54
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+76, message='moveP@24:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+76, message=f"moveP@24:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+76, message='moveP@24:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+76, message='moveP@24:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+76, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@24
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+77, message='moveP@25:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+77, message=f"moveP@25:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+77, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+77, message='moveP@25:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+77, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+77, message='moveP@25:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+77, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@25
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2078]']['name'], L.local_MR['seq_step[2078]']['addr'])
      L.ANB(L.local_MR['seq_step[2049]']['name'], L.local_MR['seq_step[2049]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[79]']['name'], L.local_T['block_timer1[79]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+79, message='wait_timer@11:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+79, error_yaml=error_yaml)
      #;action:wait_timer@11
      L.LD(L.local_MR['seq_step[79]']['name'], L.local_MR['seq_step[79]']['addr'])
      L.TMS(L.local_T['block_timer1[79]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+80, message='moveP@26:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+80, message=f"moveP@26:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+80, message='moveP@26:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+80, message='moveP@26:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@26
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+81, message='moveP@27:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+81, message=f"moveP@27:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+81, message='moveP@27:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+81, message='moveP@27:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@27
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+83, message='moveP@29:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+83, message=f"moveP@29:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+83, message='moveP@29:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+83, message='moveP@29:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+83, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@29
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(98.001, -447.154, 283.73, 177.598, 2.269, -46.0, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[83]']['name'], L.local_MR['seq_step[83]']['addr'])
      L.ANB(L.local_MR['seq_step[2083]']['name'], L.local_MR['seq_step[2083]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+84, message='moveP@30:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+84, message=f"moveP@30:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+84, message='moveP@30:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+84, message='moveP@30:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+84, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@30
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(97.996, -879.312, 169.168, 177.598, 2.27, -46.001, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[84]']['name'], L.local_MR['seq_step[84]']['addr'])
      L.ANB(L.local_MR['seq_step[2084]']['name'], L.local_MR['seq_step[2084]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+85, message='moveP@31:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+85, message=f"moveP@31:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+85, message='moveP@31:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+85, message='moveP@31:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@31
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(97.999, -879.311, 111.098, 177.599, 2.27, -46.001, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[85]']['name'], L.local_MR['seq_step[85]']['addr'])
      L.ANB(L.local_MR['seq_step[2085]']['name'], L.local_MR['seq_step[2085]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[87]']['name'], L.local_T['block_timer1[87]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+87, message='wait_timer@7:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+87, error_yaml=error_yaml)
      #;action:wait_timer@7
      L.LD(L.local_MR['seq_step[87]']['name'], L.local_MR['seq_step[87]']['addr'])
      L.TMS(L.local_T['block_timer1[87]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+88, message='moveP@32:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+88, message=f"moveP@32:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+88, message='moveP@32:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+88, message='moveP@32:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@32
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+89, message='moveP@33:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+89, message=f"moveP@33:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+89, message='moveP@33:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+89, message='moveP@33:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@33
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+91, message='moveP@34:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+91, message=f"moveP@34:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+91, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+91, message='moveP@34:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+91, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+91, message='moveP@34:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+91, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@34
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-5.636, -385.171, 293.263, -178.655, 0.129, -136.541, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[91]']['name'], L.local_MR['seq_step[91]']['addr'])
      L.ANB(L.local_MR['seq_step[2091]']['name'], L.local_MR['seq_step[2091]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+92, message='moveP@35:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+92, message=f"moveP@35:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+92, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+92, message='moveP@35:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+92, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+92, message='moveP@35:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+92, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@35
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(155.208, -385.21, 212.794, -178.69, 0.139, -136.467, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[92]']['name'], L.local_MR['seq_step[92]']['addr'])
      L.ANB(L.local_MR['seq_step[2092]']['name'], L.local_MR['seq_step[2092]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+93, message='moveP@36:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+93, message=f"moveP@36:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+93, message='moveP@36:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+93, message='moveP@36:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@36
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(155.201, -385.149, 182.635, -178.707, 0.151, -136.468, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[93]']['name'], L.local_MR['seq_step[93]']['addr'])
      L.ANB(L.local_MR['seq_step[2093]']['name'], L.local_MR['seq_step[2093]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[95]']['name'], L.local_T['block_timer1[95]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+95, message='wait_timer@9:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+95, error_yaml=error_yaml)
      #;action:wait_timer@9
      L.LD(L.local_MR['seq_step[95]']['name'], L.local_MR['seq_step[95]']['addr'])
      L.TMS(L.local_T['block_timer1[95]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+96, message='moveP@37:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+96, message=f"moveP@37:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+96, message='moveP@37:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+96, message='moveP@37:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@37
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+97, message='moveP@38:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+97, message=f"moveP@38:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+97, message='moveP@38:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+97, message='moveP@38:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@38
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+99, message='moveP@39:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+99, message=f"moveP@39:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+99, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+99, message='moveP@39:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+99, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+99, message='moveP@39:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+99, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@39
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(27.103, -384.901, -68.763, -178.706, 0.283, -136.52, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[99]']['name'], L.local_MR['seq_step[99]']['addr'])
      L.ANB(L.local_MR['seq_step[2099]']['name'], L.local_MR['seq_step[2099]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+100, message='moveP@40:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+100, message=f"moveP@40:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+100, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+100, message='moveP@40:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+100, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+100, message='moveP@40:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+100, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@40
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(27.103, -384.909, -108.883, -178.705, 0.282, -136.519, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[100]']['name'], L.local_MR['seq_step[100]']['addr'])
      L.ANB(L.local_MR['seq_step[2100]']['name'], L.local_MR['seq_step[2100]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2101]']['name'], L.local_MR['seq_step[2101]']['addr'])
      L.ANB(L.local_MR['seq_step[2068]']['name'], L.local_MR['seq_step[2068]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[102]']['name'], L.local_T['block_timer1[102]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+102, message='wait_timer@10:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+102, error_yaml=error_yaml)
      #;action:wait_timer@10
      L.LD(L.local_MR['seq_step[102]']['name'], L.local_MR['seq_step[102]']['addr'])
      L.TMS(L.local_T['block_timer1[102]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+103, message='moveP@41:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+103, message=f"moveP@41:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+103, message='moveP@41:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+103, message='moveP@41:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+103, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@41
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+104, message='moveP@42:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+104, message=f"moveP@42:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+104, message='moveP@42:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+104, message='moveP@42:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@42
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+106, message='moveP@44:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+106, message=f"moveP@44:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+106, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+106, message='moveP@44:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+106, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+106, message='moveP@44:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+106, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@44
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+107, message='moveP@45:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+107, message=f"moveP@45:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+107, message='moveP@45:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+107, message='moveP@45:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+107, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@45
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+108, message='moveP@46:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+108, message=f"moveP@46:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+108, message='moveP@46:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+108, message='moveP@46:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@46
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2109]']['name'], L.local_MR['seq_step[2109]']['addr'])
      L.ANB(L.local_MR['seq_step[2049]']['name'], L.local_MR['seq_step[2049]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[110]']['name'], L.local_T['block_timer1[110]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+110, message='wait_timer@8:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+110, error_yaml=error_yaml)
      #;action:wait_timer@8
      L.LD(L.local_MR['seq_step[110]']['name'], L.local_MR['seq_step[110]']['addr'])
      L.TMS(L.local_T['block_timer1[110]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+111, message='moveP@47:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+111, message=f"moveP@47:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+111, message='moveP@47:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+111, message='moveP@47:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@47
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+112, message='moveP@48:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+112, message=f"moveP@48:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+112, message='moveP@48:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+112, message='moveP@48:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@48
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+113, message='moveP@55:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+113, message=f"moveP@55:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+113, message='moveP@55:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+113, message='moveP@55:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@55
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-136.262, -515.952, 51.038, 179.763, -0.423, -170.288, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[113]']['name'], L.local_MR['seq_step[113]']['addr'])
      L.ANB(L.local_MR['seq_step[2113]']['name'], L.local_MR['seq_step[2113]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+115, message='moveP@49:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+115, message=f"moveP@49:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+115, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+115, message='moveP@49:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+115, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+115, message='moveP@49:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+115, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@49
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-67.102, -385.178, -76.847, -178.657, 0.125, 46.471, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[115]']['name'], L.local_MR['seq_step[115]']['addr'])
      L.ANB(L.local_MR['seq_step[2115]']['name'], L.local_MR['seq_step[2115]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+116, message='moveP@50:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+116, message=f"moveP@50:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+116, message='moveP@50:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+116, message='moveP@50:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@50
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-67.101, -385.175, -112.909, -178.657, 0.124, 46.471, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[116]']['name'], L.local_MR['seq_step[116]']['addr'])
      L.ANB(L.local_MR['seq_step[2116]']['name'], L.local_MR['seq_step[2116]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.LD(L.local_MR['seq_step[116]']['name'], L.local_MR['seq_step[116]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[116]']['addr'], 0.0)

      #;Process:procedures_callnoreturn@7
      L.LD(L.local_MR['seq_step[2116]']['name'], L.local_MR['seq_step[2116]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2117]']['name'], L.local_MR['seq_step[2117]']['addr'])
      L.ANB(L.local_MR['seq_step[2045]']['name'], L.local_MR['seq_step[2045]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+118, message='moveP@51:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+118, message=f"moveP@51:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+118, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+118, message='moveP@51:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+118, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+118, message='moveP@51:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+118, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@51
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+119, message='moveP@52:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+119, message=f"moveP@52:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+119, message='moveP@52:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+119, message='moveP@52:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@52
