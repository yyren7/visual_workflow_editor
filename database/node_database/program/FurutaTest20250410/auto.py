...
if __name__ == '__main__':
  while True:
    try:
      ...
      L.MPP()
      L.LDPB(L.local_MR['seq_step[24]']['name'], L.local_MR['seq_step[24]']['addr'])
      ...
      #;Post-Process:return@3
      #;action:return@3
      L.LDP(L.local_MR['seq_step[24]']['name'], L.local_MR['seq_step[24]']['addr'])
      if (L.aax & L.iix):
      ...
      L.TMS(L.local_T['block_timeout[26]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[26]']['name'], L.local_T['block_timeout[26]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+26, message='moveP@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+26, message=f"moveP@3:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+26, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+26, message='moveP@3:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+26, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+26, message='moveP@3:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+26, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@3
      ...
      L.LD(L.local_MR['seq_step[26]']['name'], L.local_MR['seq_step[26]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[26]']['addr'], 0)
      ...
      L.TMS(L.local_T['block_timeout[28]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[28]']['name'], L.local_T['block_timeout[28]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+28, message='moveP@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+28, message=f"moveP@4:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+28, message='moveP@4:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+28, message='moveP@4:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+28, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@4
      ...
      L.LD(L.local_MR['seq_step[28]']['name'], L.local_MR['seq_step[28]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[28]']['addr'], 0)
      ...
      L.TMS(L.local_T['block_timeout[30]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[30]']['name'], L.local_T['block_timeout[30]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+30, message='moveP@5:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+30, message=f"moveP@5:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+30, message='moveP@5:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+30, message='moveP@5:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+30, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@5
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(209.045, -467.706, 120.062, -179.393, 0.184, 47.738, 10.0, 10.0, 10.0, 0.1, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 100)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[30]']['name'], L.local_MR['seq_step[30]']['addr'])
      L.ANB(L.local_MR['seq_step[2030]']['name'], L.local_MR['seq_step[2030]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[31]']['name'], L.local_T['move_static_timer[31]']['addr'])
      ...
      L.TMS(L.local_T['block_timeout[31]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[31]']['name'], L.local_T['block_timeout[31]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+31, message='moveP@55:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+31, error_yaml=error_yaml)
      #;error:moveP@55
      L.LD(L.local_MR['seq_step[31]']['name'], L.local_MR['seq_step[31]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+31, message=f"moveP@55:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+31, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+31, message='moveP@55:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+31, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+31, message='moveP@55:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+31, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@55
      ...
      L.LD(L.local_MR['seq_step[31]']['name'], L.local_MR['seq_step[31]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[31]']['addr'], 0)

      #;Process:procedures_callnoreturn@23
      ...
      #;Post-Process:procedures_callnoreturn@23
      ...
      L.TMS(L.local_T['block_timeout[33]']['addr'], 60000000)
      L.LDP(L.local_T['block_timeout[33]']['name'], L.local_T['block_timeout[33]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+33, message='moveP@56:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+33, message=f"moveP@56:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+33, message='moveP@56:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+33, message='moveP@56:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+33, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@56
      ...
      L.LD(L.local_MR['seq_step[33]']['name'], L.local_MR['seq_step[33]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[33]']['addr'], 0)


      #;Process:procedures_defnoreturn@1
      L.LD(L.local_MR['seq_step[27]']['name'], L.local_MR['seq_step[27]']['addr'])
      L.OR(L.local_MR['seq_step[32]']['name'], L.local_MR['seq_step[32]']['addr'])
      L.OR(L.local_MR['seq_step[46]']['name'], L.local_MR['seq_step[46]']['addr'])
      L.OR(L.local_MR['seq_step[91]']['name'], L.local_MR['seq_step[91]']['addr'])
      L.OR(L.local_MR['seq_step[121]']['name'], L.local_MR['seq_step[121]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[35]']['name'], L.local_T['block_timer1[35]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+35, message='wait_timer@3:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+35, error_yaml=error_yaml)
      #;action:wait_timer@3
      L.LD(L.local_MR['seq_step[35]']['name'], L.local_MR['seq_step[35]']['addr'])
      L.TMS(L.local_T['block_timer1[35]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+36, message='set_output@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.LDP(L.local_MR['seq_step[2036]']['name'], L.local_MR['seq_step[2036]']['addr'])
      if (L.aax & L.iix):
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+37, message='wait_input@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.OR(L.local_MR['seq_step[114]']['name'], L.local_MR['seq_step[114]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+39, message='wait_timer@2:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+39, error_yaml=error_yaml)
      #;action:wait_timer@2
      L.LD(L.local_MR['seq_step[39]']['name'], L.local_MR['seq_step[39]']['addr'])
      L.TMS(L.local_T['block_timer1[39]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+40, message='set_output@2:A timeout occurred.', error_yaml=error_yaml)
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+41, message='wait_input@2:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+43, message='moveP@7:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+43, message=f"moveP@7:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+43, message='moveP@7:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+43, message='moveP@7:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+43, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@7
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+44, message='moveP@8:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+44, message=f"moveP@8:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+44, message='moveP@8:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+44, message='moveP@8:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+44, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@8
      ...
      L.LD(L.local_MR['seq_step[44]']['name'], L.local_MR['seq_step[44]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[44]']['addr'], 0.0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+45, message='moveP@9:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+45, message=f"moveP@9:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+45, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+45, message='moveP@9:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+45, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+45, message='moveP@9:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+45, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@9
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+47, message='wait_timer@4:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+47, error_yaml=error_yaml)
      #;action:wait_timer@4
      L.LD(L.local_MR['seq_step[47]']['name'], L.local_MR['seq_step[47]']['addr'])
      L.TMS(L.local_T['block_timer1[47]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+48, message='moveP@19:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+48, message=f"moveP@19:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+48, message='moveP@19:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+48, message='moveP@19:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+48, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@19
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+49, message='moveP@10:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+49, message=f"moveP@10:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+49, message='moveP@10:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+49, message='moveP@10:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+49, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@10
      ...
      L.LD(L.local_MR['seq_step[49]']['name'], L.local_MR['seq_step[49]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[49]']['addr'], 0.0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+50, message='moveP@11:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+50, message=f"moveP@11:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+50, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+50, message='moveP@11:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+50, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+50, message='moveP@11:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+50, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@11
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+51, message='moveP@12:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+51, message=f"moveP@12:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+51, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+51, message='moveP@12:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+51, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+51, message='moveP@12:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+51, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@12
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2052]']['name'], L.local_MR['seq_step[2052]']['addr'])
      L.ANB(L.local_MR['seq_step[2060]']['name'], L.local_MR['seq_step[2060]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[53]']['name'], L.local_T['block_timer1[53]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+53, message='wait_timer@14:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+53, error_yaml=error_yaml)
      #;action:wait_timer@14
      L.LD(L.local_MR['seq_step[53]']['name'], L.local_MR['seq_step[53]']['addr'])
      L.TMS(L.local_T['block_timer1[53]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+54, message='moveP@13:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+54, message=f"moveP@13:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+54, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+54, message='moveP@13:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+54, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+54, message='moveP@13:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+54, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@13
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+55, message='moveP@22:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+55, message=f"moveP@22:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+55, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+55, message='moveP@22:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+55, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+55, message='moveP@22:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+55, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@22
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+56, message='moveP@23:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+56, message=f"moveP@23:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+56, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+56, message='moveP@23:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+56, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+56, message='moveP@23:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+56, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@23
      ...
      L.OR(L.local_MR['seq_step[52]']['name'], L.local_MR['seq_step[52]']['addr'])
      L.OR(L.local_MR['seq_step[106]']['name'], L.local_MR['seq_step[106]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[58]']['name'], L.local_T['block_timer1[58]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+58, message='wait_timer@12:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+58, error_yaml=error_yaml)
      #;action:wait_timer@12
      L.LD(L.local_MR['seq_step[58]']['name'], L.local_MR['seq_step[58]']['addr'])
      L.TMS(L.local_T['block_timer1[58]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+59, message='set_output@3:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.LDP(L.local_MR['seq_step[2059]']['name'], L.local_MR['seq_step[2059]']['addr'])
      if (L.aax & L.iix):
        L.resetRelay(L.local_MR['robot_io_success[0]']['name'], L.local_MR['robot_io_success[0]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+60, message='wait_input@1:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.OR(L.local_MR['seq_step[99]']['name'], L.local_MR['seq_step[99]']['addr'])
      L.MPS()
      L.LDB(MR, 304)
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[63]']['name'], L.local_T['block_timer1[63]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+63, message='wait_timer@13:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+63, error_yaml=error_yaml)
      #;action:wait_timer@13
      L.LD(L.local_MR['seq_step[63]']['name'], L.local_MR['seq_step[63]']['addr'])
      L.TMS(L.local_T['block_timer1[63]']['addr'], wait_msec=number_param_yaml['N482']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+64, message='set_output@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      L.LDP(L.local_MR['seq_step[2064]']['name'], L.local_MR['seq_step[2064]']['addr'])
      if (L.aax & L.iix):
        L.resetRelay(L.local_MR['robot_io_success[0]']['name'], L.local_MR['robot_io_success[0]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+65, message='wait_input@4:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+80, message='moveP@54:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+80, message=f"moveP@54:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+80, message='moveP@54:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+80, message='moveP@54:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+80, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@54
      ...
      L.LDB(MR, 304)
      L.AND(robot_status['arrived'])
      L.AND(L.local_T['move_static_timer[81]']['name'], L.local_T['move_static_timer[81]']['addr'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+81, message='moveP@24:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+81, message=f"moveP@24:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+81, message='moveP@24:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+81, message='moveP@24:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+81, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@24
      ...
      L.LD(L.local_MR['seq_step[81]']['name'], L.local_MR['seq_step[81]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[81]']['addr'], 0.0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+82, message='moveP@25:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+82, message=f"moveP@25:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((10.0 == 0) or (10.0 == 0) or (10.0 == 0)):
          drive.register_error(no=801+82, message='moveP@25:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+82, message='moveP@25:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+82, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@25
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2083]']['name'], L.local_MR['seq_step[2083]']['addr'])
      L.ANB(L.local_MR['seq_step[2041]']['name'], L.local_MR['seq_step[2041]']['addr'])
      L.ANL()
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+84, message='wait_timer@11:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+84, error_yaml=error_yaml)
      #;action:wait_timer@11
      L.LD(L.local_MR['seq_step[84]']['name'], L.local_MR['seq_step[84]']['addr'])
      L.TMS(L.local_T['block_timer1[84]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+85, message='moveP@26:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+85, message=f"moveP@26:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+85, message='moveP@26:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+85, message='moveP@26:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+85, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@26
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+86, message='moveP@27:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+86, message=f"moveP@27:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+86, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+86, message='moveP@27:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+86, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+86, message='moveP@27:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+86, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@27
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+88, message='moveP@29:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+88, message=f"moveP@29:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+88, message='moveP@29:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+88, message='moveP@29:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+88, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@29
      ...
      L.LD(L.local_MR['seq_step[88]']['name'], L.local_MR['seq_step[88]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[88]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+89, message='moveP@30:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+89, message=f"moveP@30:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+89, message='moveP@30:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+89, message='moveP@30:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+89, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@30
      ...
      L.LD(L.local_MR['seq_step[89]']['name'], L.local_MR['seq_step[89]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[89]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+90, message='moveP@31:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+90, message=f"moveP@31:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+90, message='moveP@31:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+90, message='moveP@31:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+90, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@31
      ...
      L.LD(L.local_MR['seq_step[90]']['name'], L.local_MR['seq_step[90]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[90]']['addr'], 0)

      #;Process:procedures_callnoreturn@5
      L.LD(L.local_MR['seq_step[2090]']['name'], L.local_MR['seq_step[2090]']['addr'])
      L.MPS()
      L.LDB(L.local_MR['seq_step[2091]']['name'], L.local_MR['seq_step[2091]']['addr'])
      L.ANB(L.local_MR['seq_step[2037]']['name'], L.local_MR['seq_step[2037]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[92]']['name'], L.local_T['block_timer1[92]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+92, message='wait_timer@7:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+92, error_yaml=error_yaml)
      #;action:wait_timer@7
      L.LD(L.local_MR['seq_step[92]']['name'], L.local_MR['seq_step[92]']['addr'])
      L.TMS(L.local_T['block_timer1[92]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+93, message='moveP@32:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+93, message=f"moveP@32:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+93, message='moveP@32:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+93, message='moveP@32:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+93, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@32
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+94, message='moveP@33:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+94, message=f"moveP@33:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+94, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+94, message='moveP@33:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+94, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+94, message='moveP@33:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+94, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@33
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+96, message='moveP@34:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+96, message=f"moveP@34:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+96, message='moveP@34:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+96, message='moveP@34:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+96, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@34
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+97, message='moveP@35:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+97, message=f"moveP@35:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+97, message='moveP@35:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+97, message='moveP@35:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+97, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@35
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+98, message='moveP@36:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+98, message=f"moveP@36:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+98, message='moveP@36:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+98, message='moveP@36:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+98, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@36
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2099]']['name'], L.local_MR['seq_step[2099]']['addr'])
      L.ANB(L.local_MR['seq_step[2065]']['name'], L.local_MR['seq_step[2065]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[100]']['name'], L.local_T['block_timer1[100]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+100, message='wait_timer@9:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+100, error_yaml=error_yaml)
      #;action:wait_timer@9
      L.LD(L.local_MR['seq_step[100]']['name'], L.local_MR['seq_step[100]']['addr'])
      L.TMS(L.local_T['block_timer1[100]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+101, message='moveP@37:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+101, message=f"moveP@37:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+101, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+101, message='moveP@37:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+101, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+101, message='moveP@37:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+101, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@37
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+102, message='moveP@38:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+102, message=f"moveP@38:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+102, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+102, message='moveP@38:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+102, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+102, message='moveP@38:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+102, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@38
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+104, message='moveP@39:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+104, message=f"moveP@39:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+104, message='moveP@39:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+104, message='moveP@39:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+104, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@39
      ...
      L.LD(L.local_MR['seq_step[104]']['name'], L.local_MR['seq_step[104]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[104]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+105, message='moveP@40:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+105, message=f"moveP@40:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+105, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+105, message='moveP@40:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+105, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+105, message='moveP@40:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+105, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@40
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2106]']['name'], L.local_MR['seq_step[2106]']['addr'])
      L.ANB(L.local_MR['seq_step[2060]']['name'], L.local_MR['seq_step[2060]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[107]']['name'], L.local_T['block_timer1[107]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+107, message='wait_timer@10:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+107, error_yaml=error_yaml)
      #;action:wait_timer@10
      L.LD(L.local_MR['seq_step[107]']['name'], L.local_MR['seq_step[107]']['addr'])
      L.TMS(L.local_T['block_timer1[107]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+108, message='moveP@41:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+108, message=f"moveP@41:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+108, message='moveP@41:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+108, message='moveP@41:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+108, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@41
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+109, message='moveP@42:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+109, message=f"moveP@42:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+109, message='moveP@42:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+109, message='moveP@42:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+109, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@42
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+111, message='moveP@44:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+111, message=f"moveP@44:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+111, message='moveP@44:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+111, message='moveP@44:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+111, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@44
      ...
      L.LD(L.local_MR['seq_step[111]']['name'], L.local_MR['seq_step[111]']['addr'])
      L.AND(robot_status['arrived'])
      L.TMS(L.local_T['move_static_timer[111]']['addr'], 0)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+112, message='moveP@45:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+112, message=f"moveP@45:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+112, message='moveP@45:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+112, message='moveP@45:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+112, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@45
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+113, message='moveP@46:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+113, message=f"moveP@46:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+113, message='moveP@46:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+113, message='moveP@46:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+113, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@46
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2114]']['name'], L.local_MR['seq_step[2114]']['addr'])
      L.ANB(L.local_MR['seq_step[2041]']['name'], L.local_MR['seq_step[2041]']['addr'])
      L.ANL()
      ...
      L.MPP()
      L.LDB(MR, 304)
      L.AND(L.local_T['block_timer1[115]']['name'], L.local_T['block_timer1[115]']['addr'])
      ...
      if (L.aax & L.iix):
        drive.register_error(no=801+115, message='wait_timer@8:A timeout occurred.', error_yaml=error_yaml)
        drive.raise_error(no=801+115, error_yaml=error_yaml)
      #;action:wait_timer@8
      L.LD(L.local_MR['seq_step[115]']['name'], L.local_MR['seq_step[115]']['addr'])
      L.TMS(L.local_T['block_timer1[115]']['addr'], wait_msec=number_param_yaml['N483']['value'])
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+116, message='moveP@47:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+116, message=f"moveP@47:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+116, message='moveP@47:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+116, message='moveP@47:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+116, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@47
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+117, message='moveP@48:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+117, message=f"moveP@48:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+117, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+117, message='moveP@48:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+117, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+117, message='moveP@48:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+117, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@48
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+119, message='moveP@49:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+119, message=f"moveP@49:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+119, message='moveP@49:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+119, message='moveP@49:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+119, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@49
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+120, message='moveP@50:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+120, message=f"moveP@50:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+120, message='moveP@50:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+120, message='moveP@50:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+120, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@50
      ...
      L.MPS()
      L.LDB(L.local_MR['seq_step[2121]']['name'], L.local_MR['seq_step[2121]']['addr'])
      L.ANB(L.local_MR['seq_step[2037]']['name'], L.local_MR['seq_step[2037]']['addr'])
      L.ANL()
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+122, message='moveP@51:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+122, message=f"moveP@51:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+122, message='moveP@51:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+122, message='moveP@51:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+122, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@51
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        drive.register_error(no=801+123, message='moveP@52:A timeout occurred.', error_yaml=error_yaml)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 0) and (robot_status['error_id'] <= 700))):
          ...
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((robot_status['error'] == True) and ((robot_status['error_id'] > 700) and (robot_status['error_id'] <= 800))):
          drive.register_error(no=801+123, message=f"moveP@52:Robot API error occurred: No.{robot_status['error_id']}", error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if ((100.0 == 0) or (100.0 == 0) or (100.0 == 0)):
          drive.register_error(no=801+123, message='moveP@52:Target velocity, acceleration or decelerationis zero.', error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
        if (robot_status['servo'] == False):
          drive.register_error(no=801+123, message='moveP@52:Servo is off.', error_yaml=error_yaml)
          drive.raise_error(no=801+123, error_yaml=error_yaml)
          drive.update_auto_status(number_param_yaml, initial_number_param_yaml, error_yaml)
      #;action:moveP@52
      ...
      L.MPP()
      L.LDPB(L.local_MR['seq_step[124]']['name'], L.local_MR['seq_step[124]']['addr'])
