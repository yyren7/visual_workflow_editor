  ...
  while True:
    try:
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(653.55, -364.396, 342.632, -178.328, -0.418, -41.248, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(625.929, -38.22, 326.541, -178.278, 0.292, -45.666, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[2]']['name'], L.local_MR['seq_step[2]']['addr'])
      L.ANB(L.local_MR['seq_step[2002]']['name'], L.local_MR['seq_step[2002]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(625.929, -38.22, 294.931, -178.278, 0.292, -45.666, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[4]']['name'], L.local_MR['seq_step[4]']['addr'])
      L.ANB(L.local_MR['seq_step[2004]']['name'], L.local_MR['seq_step[2004]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(625.929, -38.224, 324.963, -178.278, 0.293, -45.668, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[6]']['name'], L.local_MR['seq_step[6]']['addr'])
      L.ANB(L.local_MR['seq_step[2006]']['name'], L.local_MR['seq_step[2006]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(625.928, -88.35, 324.956, -178.279, 0.293, -45.669, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[7]']['name'], L.local_MR['seq_step[7]']['addr'])
      L.ANB(L.local_MR['seq_step[2007]']['name'], L.local_MR['seq_step[2007]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(98.003, -331.997, 348.002, 177.599, 2.269, -45.997, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[16]']['name'], L.local_MR['seq_step[16]']['addr'])
      L.ANB(L.local_MR['seq_step[2016]']['name'], L.local_MR['seq_step[2016]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-255.919, -163.018, 374.977, 177.37, -0.033, -134.997, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[21]']['name'], L.local_MR['seq_step[21]']['addr'])
      L.ANB(L.local_MR['seq_step[2021]']['name'], L.local_MR['seq_step[2021]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-5.633, -385.173, 293.248, -178.654, 0.128, 46.469, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[34]']['name'], L.local_MR['seq_step[34]']['addr'])
      L.ANB(L.local_MR['seq_step[2034]']['name'], L.local_MR['seq_step[2034]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(209.044, -467.708, 120.063, -179.393, 0.186, 47.739, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[35]']['name'], L.local_MR['seq_step[35]']['addr'])
      L.ANB(L.local_MR['seq_step[2035]']['name'], L.local_MR['seq_step[2035]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(209.058, -467.669, 59.974, -179.387, 0.18, 47.741, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[37]']['name'], L.local_MR['seq_step[37]']['addr'])
      L.ANB(L.local_MR['seq_step[2037]']['name'], L.local_MR['seq_step[2037]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-734.356, -173.218, 239.7, -178.932, 2.789, -132.003, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[52]']['name'], L.local_MR['seq_step[52]']['addr'])
      L.ANB(L.local_MR['seq_step[2052]']['name'], L.local_MR['seq_step[2052]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-730.419, -175.589, 182.897, -179.718, 0.899, -131.968, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[53]']['name'], L.local_MR['seq_step[53]']['addr'])
      L.ANB(L.local_MR['seq_step[2053]']['name'], L.local_MR['seq_step[2053]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-734.355, -173.221, 239.704, -178.933, 2.789, -132.003, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[56]']['name'], L.local_MR['seq_step[56]']['addr'])
      L.ANB(L.local_MR['seq_step[2056]']['name'], L.local_MR['seq_step[2056]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-517.2, -165.2, 272.657, 179.809, 2.164, 46.48, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[57]']['name'], L.local_MR['seq_step[57]']['addr'])
      L.ANB(L.local_MR['seq_step[2057]']['name'], L.local_MR['seq_step[2057]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-770.679, -172.126, 233.278, 178.914, 0.08, 45.758, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[58]']['name'], L.local_MR['seq_step[58]']['addr'])
      L.ANB(L.local_MR['seq_step[2058]']['name'], L.local_MR['seq_step[2058]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-770.644, -172.112, 214.933, 178.905, 0.067, 45.761, 10.0, 10.0, 10.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[59]']['name'], L.local_MR['seq_step[59]']['addr'])
      L.ANB(L.local_MR['seq_step[2059]']['name'], L.local_MR['seq_step[2059]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-770.677, -172.126, 233.272, 178.914, 0.079, 45.759, 10.0, 10.0, 10.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[62]']['name'], L.local_MR['seq_step[62]']['addr'])
      L.ANB(L.local_MR['seq_step[2062]']['name'], L.local_MR['seq_step[2062]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-511.236, -163.017, 337.492, 177.37, -0.032, -134.999, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[63]']['name'], L.local_MR['seq_step[63]']['addr'])
      L.ANB(L.local_MR['seq_step[2063]']['name'], L.local_MR['seq_step[2063]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(98.001, -447.154, 283.73, 177.598, 2.269, -46.0, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[82]']['name'], L.local_MR['seq_step[82]']['addr'])
      L.ANB(L.local_MR['seq_step[2082]']['name'], L.local_MR['seq_step[2082]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(97.996, -879.312, 169.168, 177.598, 2.27, -46.001, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[83]']['name'], L.local_MR['seq_step[83]']['addr'])
      L.ANB(L.local_MR['seq_step[2083]']['name'], L.local_MR['seq_step[2083]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(97.999, -879.311, 111.098, 177.599, 2.27, -46.001, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[84]']['name'], L.local_MR['seq_step[84]']['addr'])
      L.ANB(L.local_MR['seq_step[2084]']['name'], L.local_MR['seq_step[2084]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-5.636, -385.171, 293.263, -178.655, 0.129, -136.541, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[90]']['name'], L.local_MR['seq_step[90]']['addr'])
      L.ANB(L.local_MR['seq_step[2090]']['name'], L.local_MR['seq_step[2090]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(155.208, -385.21, 212.794, -178.69, 0.139, -136.467, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[91]']['name'], L.local_MR['seq_step[91]']['addr'])
      L.ANB(L.local_MR['seq_step[2091]']['name'], L.local_MR['seq_step[2091]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(155.201, -385.149, 182.635, -178.707, 0.151, -136.468, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[92]']['name'], L.local_MR['seq_step[92]']['addr'])
      L.ANB(L.local_MR['seq_step[2092]']['name'], L.local_MR['seq_step[2092]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(27.103, -384.901, -68.763, -178.706, 0.283, -136.52, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[98]']['name'], L.local_MR['seq_step[98]']['addr'])
      L.ANB(L.local_MR['seq_step[2098]']['name'], L.local_MR['seq_step[2098]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(27.103, -384.909, -108.883, -178.705, 0.282, -136.519, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[99]']['name'], L.local_MR['seq_step[99]']['addr'])
      L.ANB(L.local_MR['seq_step[2099]']['name'], L.local_MR['seq_step[2099]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-136.262, -515.952, 51.038, 179.763, -0.423, -170.288, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[112]']['name'], L.local_MR['seq_step[112]']['addr'])
      L.ANB(L.local_MR['seq_step[2112]']['name'], L.local_MR['seq_step[2112]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-67.102, -385.178, -76.847, -178.657, 0.125, 46.471, 100.0, 100.0, 100.0, 5.0, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[114]']['name'], L.local_MR['seq_step[114]']['addr'])
      L.ANB(L.local_MR['seq_step[2114]']['name'], L.local_MR['seq_step[2114]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
      ...
      if ((L.aax & L.iix) and (RAC.connected)):
        ...
        offset_ry = 0
        offset_rz = 0
        x, y, z, rx, ry, rz, vel, acc, dec, dist, stime, tool = L.FB_setRobotParam(-67.101, -385.175, -112.909, -178.657, 0.124, 46.471, 100.0, 100.0, 100.0, 0.2, 0.0, 0.0, offset_x, offset_y, offset_z, offset_rx, offset_ry, offset_rz, 10)
        RAC.send_command(f'moveAbsolutePtp({x}, {y}, {z}, {rx}, {ry}, {rz}, {vel}, {acc}, {dec}, {int(tool)})')
      L.LD(L.local_MR['seq_step[115]']['name'], L.local_MR['seq_step[115]']['addr'])
      L.ANB(L.local_MR['seq_step[2115]']['name'], L.local_MR['seq_step[2115]']['addr'])
      if ((L.aax & L.iix) and (RAC.connected)):
